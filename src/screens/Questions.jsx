...
const Questions = () => {
  ...
  const handleOptionClick = (selectedOption) => {
    ...
    if (result) {
      ...
      setPoints(points - 1);
      console.log(points);
      // Decrease points by 1 for incorrect answer
    }
  };
  ...
  return (
    <div className="container mx-auto p-8 bg-slate-600 min-h-screen flex justify-center items-center">
      {loading ? (
        ...
        <div className="rounded-lg shadow-md p-6 bg-slate-400 my-4 w-full">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 my-4">
            Question. {question[currentQuestion].description}
          </h2>
